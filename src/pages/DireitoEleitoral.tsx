...
import { Vote, FileText, Clock, CheckCircle, MessageCircle } from "lucide-react";
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              Atuação completa em todas as questões eleitorais
            </p>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
              {[
                { icon: FileText, title: "1. Consulta", desc: "Análise inicial da situação eleitoral" },
                { icon: Vote, title: "2. Planejamento", desc: "Estratégia jurídica personalizada" },
                { icon: Clock, title: "3. Execução", desc: "Acompanhamento dos prazos eleitorais" },
